...
export const ScenarioBar: React.FC = () => {
  ...
  return (
    <aside aria-label="Demo Scenario Switcher" className="w-full border-b border-hairline/70 bg-paper-surface/40 backdrop-blur-sm px-4 py-2 transition-colors duration-300">
      <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-3 text-xs">
        {/* Left: Hackathon Judge Cue */}
        ...
        {/* Center: Scenario Quick-Switch Buttons */}
